...
analysis_name = 'table_base_model_field_meas_time_points'
...
if analysis_name == 'scatter_accuracy':
    ...
    fig.update_layout(
        template='seaborn',
        yaxis_title='Predicted streamflow (feet\u00B3)',
        xaxis_title='Observed streamflow (feet\u00B3)',
        showlegend=True,
        plot_bgcolor='white',
        xaxis=dict(
            showline=True,
    ...
    fig.write_html(f'{dir_save_fig}/scatter_observed_vs_pred_{horizon}_{model_group_label}.html')
    io.write_image(fig, f'{dir_save_fig}/scatter_observed_vs_pred_{horizon}_{model_group_label}.png', scale=4)

if analysis_name == 'line_accuracy':
    ...
    # import precip data
    if os.path.isfile(f'./data/cache/data_precip_{target_gage}.csv'):
        data_precip = pd.read_csv(f'./data/cache/data_precip_{target_gage}.csv', index_col=0, parse_dates=True)
        ...
        data_precip.to_csv(f'./data/cache/data_precip_{target_gage}.csv')
    ...
    fig.write_html(f'{dir_save_fig}/line_observed_vs_pred_{horizon}_action{action_num}.html')
    io.write_image(fig, f'{dir_save_fig}/line_observed_vs_pred_{horizon}_action{action_num}.png', scale=4)
...
if analysis_name == 'scatter_error':
    import math
    dir_expr = './outputs/experiments/ARCHIVE_pi_hodcrnn_tune_o1_1__2024-03-15-21-04-03'
    dir_save = './papers/figs'
    horizon = 1
    ...
    fig.write_html(f'{dir_save}/scatter_error_per_vs_level_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_error_per_vs_level_{horizon}.png', scale=4)
    ...
    fig.write_html(f'{dir_save}/scatter_error_per_vs_level_select_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_error_per_vs_level_select_{horizon}.png', scale=4)
    ...
    fig = go.Figure()
    fig.add_trace(go.Scatter(
        x=list(range(min_per_level_change - 1, max_per_level_change + 2)),
    ...
    fig.write_html(f'{dir_save}/scatter_error_per_vs_change_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_error_per_vs_change_{horizon}.png', scale=4)

if analysis_name == 'tuner_o1':
    import math
    import pickle
    dir_expr = './outputs/experiments/ARCHIVE_pi_hodcrnn_tune_o1_1__2024-03-15-21-04-03'
    dir_save = './papers/figs'
    ...
    fig.write_html(f'{dir_save}/scatter_model_o1_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_model_o1_{horizon}.png', scale=4)

if analysis_name == 'tuner_o2':
    import math
    import pickle
    dir_expr = './outputs/experiments/ARCHIVE_pi_hodcrnn_tune_o2_1__2024-03-15-23-35-45'
    dir_save = './papers/figs'
    horizon = 1
    ...
    fig.write_html(f'{dir_save}/scatter_model_o1_result_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_model_o1_result_{horizon}.png', scale=4)
    ...
    fig.write_html(f'{dir_save}/scatter_model_o2_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_model_o2_{horizon}.png', scale=4)

if analysis_name == 'tuner_o2_post':
    import math
    import pickle
    ...
    fig.write_html(f'{dir_save}/scatter_model_o2_result_{horizon}.html')
    io.write_image(fig, f'{dir_save}/scatter_model_o2_result_{horizon}.png', scale=4)

if analysis_name == 'tuner_o3_post':
    import math
    import pickle
    dir_expr = './outputs/experiments/ARCHIVE_pi_hodcrnn_tune_o3_1__2024-03-16-17-43-59'
    dir_save = './papers/figs'
...
if analysis_name == 'table_metrics':
    ...
    table_name = 'table_metric_high_field_tuning'
    use_col = ['field_high']
    model_list = [
    #     'naive', 'linear', 'mlp', 'xgboost', 'gru', 'hodcrnn',
        'pi_hodcrnn',
        'pi_hodcrnn_tune_o1', 'pi_hodcrnn_tune_o2', 'pi_hodcrnn_tune_o3', 'pi_hodcrnn_tune_l',
    ]
    horizon_list = [
        1,
        # 2, 3, 4, 5, 6
...
if analysis_name == 'line_metric_field_modeled':
    ...
    fig.write_html(f'{dir_save_fig}/line_{metric[0]}_vs_horizon_overall.html')
    io.write_image(fig, f'{dir_save_fig}/line_{metric[0]}_vs_horizon_overall.png', scale=4)
    ...
    fig.write_html(f'{dir_save_fig}/line_{metric[0]}_vs_horizon_high.html')
    io.write_image(fig, f'{dir_save_fig}/line_{metric[0]}_vs_horizon_high.png', scale=4)
