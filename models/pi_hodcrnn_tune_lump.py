...
def train_pred(
    ...
    train_x_last = (train_x_last * (df[f"{target_gage}_00065"].max() - df[f"{target_gage}_00065"].min())
                    + df[f"{target_gage}_00065"].min())
    val_x_last = val_x_raw[:, -1:, 0][val_df_field_index]
    val_x_last = (val_x_last * (df[f"{target_gage}_00065"].max() - df[f"{target_gage}_00065"].min())
                    + df[f"{target_gage}_00065"].min())
    ...
    test_x_last = (test_x_last * (df[f"{target_gage}_00065"].max() - df[f"{target_gage}_00065"].min())
                    + df[f"{target_gage}_00065"].min())
